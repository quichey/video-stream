...
client_count = os.environ.get("CLIENT_COUNT")  # number of users

# TESTING LOCAL SETUP
# Define the host and port
host = os.environ.get("CLIENT_HOST")  #loopback address (localhost)
port = os.environ.get("CLIENT_PORT")  # Port number, should be above 1024 to avoid conflicts with well-known ports
